			...
			<PageWrapper>
				...
				<main className="flex lg:flex-row lg:columns-2 flex-col justify-center align-middle items-center w-full h-fit">
					<div className="lg:w-1/2 md:w-3/4 w-full col-span-1 relative justify-center flex mt-5 h-full flex-wrap">
						<div className="w-3/5 border-2 rounded-xl cursor-pointer border-zinc-800 flex flex-col items-center pt-14 hover:border-blue-600" onClick={() => {router.push("/learn")}}>
					...
					<div className="lg:w-1/2 md:w-3/4 w-full col-span-1 relative justify-center flex mt-5 h-full">
						<div className="w-3/5 border-2 rounded-xl cursor-pointer border-zinc-800 flex flex-col items-center pt-12 hover:border-blue-600" onClick={() => {router.push("/train")}}>
