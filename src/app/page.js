...
export default function Home() {
	return (
		...
		<main className="flex-row flex columns-2 justify-center align-middle items-center w-full">
			...
			<br/> <div className="mt-4"><span className="text-3xl font-bold text-white border-4 border-blue-600 bg-blue-600 hover:border-white px-4 m-4 py-3 rounded-2xl hover:cursor-pointer"> Try Now! </span></div>
			</div>
		</main>
		</>
	)
